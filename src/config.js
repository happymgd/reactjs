...
const bookingProcessAlias = 'auto-accept-unit-time-without-stripe/release-1';
...
const listingMinimumPriceSubUnits = 4000;
...
const siteTitle = 'Guerizen';

// Twitter handle is needed in meta tags (twitter:site). Start it with '@' character
const siteTwitterHandle = null;

// Instagram page is used in SEO schema (http://schema.org/Organization)
const siteInstagramPage = 'https://www.instagram.com/guerizen/';

// Facebook page is used in SEO schema (http://schema.org/Organization)
const siteFacebookPage = 'https://www.facebook.com/Guerizen/';
