...
export const SUPPORTED_TABS = [DESCRIPTION,POLICY, FEATURES,SESSION,  LOCATION, PRICING, PHOTOS];
...
const EditListingWizardTab = props => {
  ...
  switch (tab) {
    ...
    case POLICY: {
     ...
     case SESSION: {
      const submitButtonTranslationKey = isNew
        ? 'EditListingWizard.saveNewSession'
        : 'EditListingWizard.saveEditSession';
      return (
        <EditListingSessionPanel
          {...panelProps(SESSION)}
          submitButtonText={intl.formatMessage({ id: submitButtonTranslationKey })}
