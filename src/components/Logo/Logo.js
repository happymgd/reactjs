...
import LogoMobileImage from './android-chrome-144x144.png';
...
const Logo = props => {
  ...
  if (format === 'desktop') {
    ...
    return <img className={mobileClasses} height="50" width="50" src={LogoMobileImage} alt={config.siteTitle} {...rest} />;
